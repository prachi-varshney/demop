                                ...
                                <form id="search">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <button type="button" class="btn btn btn-dark" onclick="">Search</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form id="dataFrom" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label">Item Name<span class="req-star">*</span></label>
                                            <input type="text" class="form-control form-control-sm" name="itemname"
                                                id="itemname" required maxlength="50" />
                                        </div>

                                        <div class="mb-3 col-md-3">
                                            <label class="form-label">Item Price<span class="req-star">*</span></label>
                                            <input type="number" class="form-control form-control-sm" name="itemprice"
                                                id="itemprice" required maxlength="50" />
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="itemdescription" id="itemdescription" required maxlength="10" />
                                        </div>

                                        <div class="mb-3 col-md-3">
                                            <label class="form-label">Item Image<span class="req-star">*</span></label>
                                            <input type="file" class="form-control form-control-sm" name="itemimage"
                                                id="itemimage" required accept=".jpg, .jpeg, .png, .gif" />
                                        </div>
                                    </div>
