                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center m-4">
                                        <img src="assets/img/logo.png" alt="Charles Hall" class="img-fluid rounded-circle" width="200" height="200" />
                                    </div>
                                    <form id="loginFrom">
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input class="form-control form-control-lg" type="email" name="email" placeholder="Enter your email" maxlength="50" required/>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="text-center mt-3">
                                            <button class="btn btn-sm btn-primary" type="button" onclick="Login()"> Sign in</button>
