                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="dataFrom" enctype="multipart/form-data">
                                    <div class="row">
                                    <input type="hidden" class="" name="id" id="id" required/>
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="phone_no" id="phone_no" required maxlength="10"/>
                                        </div>

                                        <div class="mb-3 col-md-3">
                                            <label class="form-label">Password <span class="req-star">*</span></label>
                                            <input type="text" class="form-control form-control-sm" name="password" id="password" required maxlength="20"/>
                                        </div>
                                    </div>
